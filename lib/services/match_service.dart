    ...
    final List<Map<String, dynamic>> sampleMatches = [
      {
        ...
        'teamBLogoUrl': 'https://flagcdn.com/w160/au.png',
        'scoreA': '178/4',
        'scoreB': '165/8',
        'status': 'Live',
      ...
      },
      {
        'teamA': 'England',
        'teamB': 'South Africa',
        'teamALogoUrl': 'https://flagcdn.com/w160/gb-eng.png',
        'teamBLogoUrl': 'https://flagcdn.com/w160/za.png',
        'scoreA': '224/5',
        'scoreB': '98/2',
        'status': 'Live',
        'matchDate': Timestamp.fromDate(now.subtract(const Duration(minutes: 40))),
      ...
      },
      {
        ...
        'scoreB': '0/0',
        'status': 'Upcoming',
        'matchDate': Timestamp.fromDate(now.add(const Duration(hours: 5))),
